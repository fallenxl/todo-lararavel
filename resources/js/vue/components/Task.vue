...
<template>
    ...
    <li :class="{'line-through opacity-40': task.completed, 'bg-gray-700 opacity-100': isSelected(task)}"  class="bg-[#161b22] rounded-lg p-4 ">
        <div class="flex items-center justify-between">
            ...
            <button @click="deleteTask(task.id)" class=" text-white font-bold py-2 px-4 rounded ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-6 h-6 fill-red-500 hover:fill-red-700" viewBox="0 0 48 48">
